...
class UnsharpDrawer extends StatelessWidget {
  ...
  final Redditor user;
  const UnsharpDrawer({Key? key, required this.user}) : super(key: key);
  ...
  Widget build(context) {
    return Drawer(
      ...
      children: [
        ...
        const DrawerButton(icon: Icons.home, route: '/home', title: 'Accueil'),
        const DrawerButton(
            icon: Icons.account_circle, route: '/user', title: 'Profile'),
        const DrawerButton(
            icon: Icons.search, route: '/search', title: 'Search'),
        const DrawerButton(
            icon: Icons.settings, route: '/settings', title: 'Settings'),
