...
class _HomePageControllerState extends State<HomePageController> {
  ...
  Widget build(BuildContext context) {
    ...
    for (String name
        in GetIt.I<RedditInterface>().loggedRedditor.subscribedSubreddits) {
    ...
    return HomePageView(
        frontPageFetcher: GetIt.I<RedditInterface>().getFrontPage,
        subscribedSubredditsFetcher: subredditFetchers);
  }
}
